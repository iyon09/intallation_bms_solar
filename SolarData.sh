...
echo "===This Script is made by Danial==="
echo "=== [1/7] Install Python and pip ==="
opkg update

echo "=== [2/7] Install python3 and pip ==="
opkg install python3 python3-pip

echo "=== [3/7] Install Python libraries ==="
pip3 install pyserial paho-mqtt

echo "=== [4/7] Create /usr/bin/querybatteryinfo.py ==="
...
echo "=== [5/7] Create /etc/init.d/mybmsread ==="
...
echo "=== [6/7] Stop and disable old spregread (if exists) ==="
if [ -x /etc/init.d/spregread ]; then
  /etc/init.d/spregread stop
  /etc/init.d/spregread disable
else
  echo "No spregread service found. Skipping..."
fi

echo "=== [7/7] Enable and start new mybmsread service ==="
